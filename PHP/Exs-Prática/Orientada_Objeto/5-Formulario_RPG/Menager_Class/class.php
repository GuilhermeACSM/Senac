...
abstract class Personagem
{
    ...
    */
    ...
    public function andarFrente()
    {
        return "{$this->nome} anda para frente.";
    }
    public function andarTras()
    {
        return "{$this->nome} anda para trás.";
    }
    public function esquivar()
    {
        return "{$this->nome} se esquiva rapidamente.";
    }
    ...
    {
        return "{$this->nome} ataca com um {$this->habilidade}!";
    }
...
$personagens = [
    "Guerreiro" => new \B\Guerreiro(),
    "Arqueiro" => new \A\Arqueiro(),
    "Mago" => new \B\Mago(),
    "Ladrão" => new \A\Ladrao(),
    "Ninja" => new \B\Ninja(),
    "Sacerdote" => new \B\Sacerdote(),
    "Anão" => new \A\Anao(),
    "Herói" => new \B\Heroi(),
];
...
class Guerreiro extends Personagem
{
    public function __construct()
    {
        parent::__construct("Guerreiro", "img/cavaleiro.png", 100, 90, 30, 30, "Espada Devastadora");
    }
    public function golpePoderoso()
    {
        return "{$this->nome} usa uma Espada Devastadora!";
